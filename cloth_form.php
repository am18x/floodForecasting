        ...
        <?php
            if(isset($_SESSION['login_id']))
              echo "
                ...
                <button class='nav-link btn me-md-2 profile-button' style='width: 35px; background-color: #F5A6EE'><i class='fa-solid fa-user'></i></button>";
            if(!isset($_SESSION['login_id']))
              echo "<a class='nav-link btn me-md-2'  href='index.php'>Home</a>
              <a class='nav-link btn me-md-2'  href='help.php'>Help</a>
        ...
        <div class='card'>
            <div class="card-body">
              <form id="clothform" enctype="multipart/form-data">
                  ...
                  <label class="control-label form-label" for="rate">Price:</label>
                  <input type="text" class="form-control" id="rate" name="rate" required>

                  <label class="control-label form-label" for="size">Available Sizes:</label>
                  ...
                  <textarea class="form-control" name="address" id="address"><?php echo getAddress(); ?></textarea>
                  ...
                  <br><br>
                  <center><button type="submit" class="btn btn-bg btn-block btn-wave col-md-2 btn-primary" style='background-color: #E84F62'>Save</button></center>

                  <script>
                    document.getElementById("clothform").addEventListener("submit", function (event) {

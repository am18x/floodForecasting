...
$tNumRoom = $_POST['tNumRoom'];
$aNumRoom = $_POST['aNumRoom'];
...
$sql = "INSERT INTO shelter (oname, rate, tNumRoom, aNumRoom, address, mob) VALUES (?, ?, ?, ?, ?, ?)";
$stmt = $conn->prepare($sql);
$stmt->bind_param("ssssss", $owner_name, $rate, $tNumRoom, $aNumRoom, $address, $mob);
$stmt->execute();
